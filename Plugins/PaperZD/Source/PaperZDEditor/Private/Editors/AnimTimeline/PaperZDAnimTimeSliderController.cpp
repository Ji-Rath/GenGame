...
struct FPaperZDAnimTimeSliderController::FScrubRangeToScreen
{
	double ViewStart;
...
FPaperZDAnimTimeSliderController::FPaperZDAnimTimeSliderController(const FTimeSliderArgs& InArgs, TWeakPtr<FPaperZDAnimModel> InWeakModel, TWeakPtr<SPaperZDAnimTimeline> InWeakTimeline)
...
FFrameTime FPaperZDAnimTimeSliderController::ComputeFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition, FScrubRangeToScreen RangeToScreen, bool CheckSnapping) const
{
...
FPaperZDAnimTimeSliderController::FScrubPixelRange FPaperZDAnimTimeSliderController::GetHitTestScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
...
FPaperZDAnimTimeSliderController::FScrubPixelRange FPaperZDAnimTimeSliderController::GetScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
	return GetScrubberPixelRange(ScrubTime, GetTickResolution(), GetDisplayRate(), RangeToScreen);
}

FPaperZDAnimTimeSliderController::FScrubPixelRange FPaperZDAnimTimeSliderController::GetScrubberPixelRange(FFrameTime ScrubTime, FFrameRate Resolution, FFrameRate PlayRate, const FScrubRangeToScreen& RangeToScreen, float DilationPixels) const
{
...
struct FPaperZDAnimTimeSliderController::FDrawTickArgs
{
...
void FPaperZDAnimTimeSliderController::DrawTicks(FSlateWindowElementList& OutDrawElements, const TRange<double>& ViewRange, const FScrubRangeToScreen& RangeToScreen, FDrawTickArgs& InArgs) const
{
	TSharedPtr<SPaperZDAnimTimeline> Timeline = WeakTimeline.Pin();
	if (!Timeline.IsValid())
	{
		return;
	}
...
int32 FPaperZDAnimTimeSliderController::OnPaintTimeSlider(bool bMirrorLabels, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled) const
{
	...
	if (LocalSequenceLength > 0)
	{
...

		{
			...
			if (GetDefault<UPaperZDEditorSettings>()->bTimelineDisplayPercentage)
			{
...
int32 FPaperZDAnimTimeSliderController::DrawSelectionRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FPaperZDAnimTimeSliderController::DrawPlaybackRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FPaperZDAnimTimeSliderController::DrawEditableTimes(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen) const
{
	const FLinearColor TimeColor = GetDefault<UPaperZDEditorSettings>()->SectionTimingNodeColor;
...
FReply FPaperZDAnimTimeSliderController::OnMouseButtonDown(SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
	DistanceDragged = 0;
...
FReply FPaperZDAnimTimeSliderController::OnMouseButtonUp(SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
FReply FPaperZDAnimTimeSliderController::OnMouseMove(SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
void FPaperZDAnimTimeSliderController::CommitScrubPosition(FFrameTime NewValue, bool bIsScrubbing)
{
...
FReply FPaperZDAnimTimeSliderController::OnMouseWheel(SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
int32 FPaperZDAnimTimeSliderController::OnPaintViewArea(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, bool bEnabled, const FPaintViewAreaArgs& Args) const
{
	const ESlateDrawEffect DrawEffects = bEnabled ? ESlateDrawEffect::None : ESlateDrawEffect::DisabledEffect;
	...
	TSharedPtr<FPaperZDAnimModel> AnimModel = WeakModel.Pin();
	if (AnimModel.IsValid())
	{
		const FLinearColor LineColor = GetDefault<UPaperZDEditorSettings>()->SectionTimingNodeColor;
...
FFrameTime FPaperZDAnimTimeSliderController::GetFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition) const
{
...
TSharedRef<SWidget> FPaperZDAnimTimeSliderController::OpenSetPlaybackRangeMenu(FFrameNumber FrameNumber)
{
...
void FPaperZDAnimTimeSliderController::ClampViewRange(double& NewRangeMin, double& NewRangeMax)
{
...
void FPaperZDAnimTimeSliderController::SetViewRange(double NewRangeMin, double NewRangeMax, EViewRangeInterpolation Interpolation)
{
...
void FPaperZDAnimTimeSliderController::SetClampRange(double NewRangeMin, double NewRangeMax)
{
...
void FPaperZDAnimTimeSliderController::SetPlayRange(FFrameNumber RangeStart, int32 RangeDuration)
{
...
bool FPaperZDAnimTimeSliderController::ZoomByDelta(float InDelta, float MousePositionFraction)
{
...
void FPaperZDAnimTimeSliderController::PanByDelta(float InDelta)
{
	TRange<double> LocalViewRange = TimeSliderArgs.ViewRange.Get().GetAnimationTarget();
...
bool FPaperZDAnimTimeSliderController::HitTestRangeStart(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FPaperZDAnimTimeSliderController::HitTestRangeEnd(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FPaperZDAnimTimeSliderController::HitTestTime(const FScrubRangeToScreen& RangeToScreen, double Time, float HitPixel) const
{
...
void FPaperZDAnimTimeSliderController::SetPlaybackRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FPaperZDAnimTimeSliderController::SetPlaybackRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FPaperZDAnimTimeSliderController::SetSelectionRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
void FPaperZDAnimTimeSliderController::SetSelectionRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
int32 FPaperZDAnimTimeSliderController::HitTestTimes(const FScrubRangeToScreen& RangeToScreen, float HitPixel) const
{
...
void FPaperZDAnimTimeSliderController::SetEditableTime(int32 TimeIndex, float Time, bool bIsDragging)
{
	TSharedPtr<FPaperZDAnimModel> Model = WeakModel.Pin();
